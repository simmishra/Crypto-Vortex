      ...
      {loading ? (<Loader/> ): (<>
        ...
        <Box width={"full"} borderWidth={1}>
          ...
          <VStack spacing={"4"} padding={"16"} alignItems={"flex-start"}>
              ...
              <CustomBar high={`${currencySymbol}${coin.market_data.high_24h[currency]}`} low={`${currencySymbol}${coin.market_data.low_24h[currency]}`} val={`${coin.market_data.price_change_percentage_24h*100}`}/>
...
const CustomBar = ({high,low,val})=>(
  <VStack w={"full"}>
    <Progress value={val} colorScheme={"teal"} w={"full"}/>
